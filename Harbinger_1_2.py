    ...
    def __init__(self):
        ...
        def aKey(event): #Move left
            ...
            if self.__Frame == 0 and self.__sprint == False and self.__crouch == False: #Moving left without sprint or crouch FRAME #1
                ...
                self.myCanvas.coords(a_bandana3, 145+self.__x-14, 150+self.__y, 140+self.__x-4, 148+self.__y, 140+self.__x-4, 151+self.__y) 
                self.myCanvas.coords(a_vneck, 140+self.__x-4, 150+self.__y, 145+self.__x-14, 163+self.__y, 125+self.__x+26, 170+self.__y, 115+self.__x+46, 160+self.__y) #(10,0), (0,8), (-20,-5), (-15,-15)
                self.myCanvas.coords(a_coat, 142+self.__x-8, 145+self.__y, 152+self.__x-28, 155+self.__y, 85+self.__x+76, 180+self.__y, 80+self.__x+104, 180+self.__y, 125+self.__x+26, 155+self.__y)
                self.__Frame = 1
                ...
                self.myCanvas.coords(a_coat, 142+self.__x-8, 145+2+self.__y, 152+self.__x-28, 155+2+self.__y, 85+self.__x+76, 180+2+self.__y, 80+self.__x+104, 180+2+self.__y, 125+self.__x+26, 155+2+self.__y)
                #(12,0) (10,10), (-35,0), (-30,-20), (-5,-5)
        ...
        def dKey(event): #Move right
            ...
            if self.__Frame == 0 and self.__sprint == False and self.__crouch == False: #Moving right without sprinting or crouching FRAME #1
                ...
                self.myCanvas.coords(a_bandana3, 145+self.__x, 150+self.__y, 140+self.__x, 148+self.__y, 140+self.__x, 151+self.__y) 
                self.myCanvas.coords(a_vneck, 140+self.__x, 150+self.__y, 145+self.__x, 163+self.__y, 125+self.__x, 170+self.__y, 115+self.__x, 160+self.__y) #(10,0), (0,8), (-20,-5), (-15,-15)
                self.myCanvas.coords(a_coat, 142+self.__x, 145+self.__y, 152+self.__x, 155+self.__y, 115+self.__x, 180+self.__y, 92+self.__x, 180+self.__y, 125+self.__x, 155+self.__y)
                self.__Frame = 1
                ...
                self.myCanvas.coords(a_coat, 142+self.__x, 145+2+self.__y, 152+self.__x, 155+2+self.__y, 115+self.__x, 180+2+self.__y, 92+self.__x, 180+2+self.__y, 125+self.__x, 155+2+self.__y)
                self.__Frame = 0
        ...
        self.master.title("Harbinger - Alpha 1.5: Crouching Update") #Titles the window "Harbinger"
        ...
        a_description = self.myCanvas.create_text(0, 0, text="""Press 'd' or 'a' to move. Hold 'd' or 'a' to walk. \nPress Shift to change from walking to running. Vise-vera."""
                                                  ...
                                                  """ \nWill try to make him jump next update.""",
        ...
        a_name = self.myCanvas.create_text(138, 110, text="Titus", width=1000, fill="green", anchor="center", font=("Fixedsys", 16))
