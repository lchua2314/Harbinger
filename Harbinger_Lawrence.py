...
class Enemy:
    def __init__(self,canvas):
        ...
        self.e1_name1 = canvas.create_text(750, 70, anchor="center", fill="red", text="Small Cyclops Warrior", font=("Fixedsys", 16))
        #shoulder
...
class Player:
    def __init__(self,canvas):
        ...
        self.a_name = canvas.create_text(138, 110, text="Jensen", width=1000, fill="green", anchor="center", font=("Fixedsys", 16))
